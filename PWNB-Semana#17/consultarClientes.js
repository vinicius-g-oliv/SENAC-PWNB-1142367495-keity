function carregarTabelaClientes() {
    ...
    // Limpar a tabela
    tabelaClientes.innerHTML = "<tr><th>Nome</th><th>Sobrenome</th><th>Data de Nascimento</th><th>E-mail</th><th>CPF</th><th>RG</th><th>CEP</th><th>Endereço</th><th>Número</th><th>UF</th><th>Ramo de Negócio</th><th>Nome da Empresa</th><th>Data de Criação</th><th>CNPJ</th><th>Descrição do Negócio</th><th>Redes Sociais</th><th>Senha</th><th>Ações</th></tr>";
    ...
    listaClientes.forEach(function(cliente, index) {
        ...
        row.insertCell(4).textContent = cliente.cpf;
        row.insertCell(5).textContent = cliente.rg;
        row.insertCell(6).textContent = cliente.cep;
        row.insertCell(7).textContent = cliente.endereco;
        row.insertCell(8).textContent = cliente.numero;
        row.insertCell(9).textContent = cliente.uf;
        row.insertCell(10).textContent = cliente.ramo;
        row.insertCell(11).textContent = cliente.nomeEmpresa;
        row.insertCell(12).textContent = cliente.dataCriacao;
        row.insertCell(13).textContent = cliente.cnpj;
        row.insertCell(14).textContent = cliente.descricao;
        row.insertCell(15).textContent = cliente.redes;
        row.insertCell(16).textContent = cliente.senha;

        // Adicionar coluna de ações com botões de editar e excluir
        var cellAcoes = row.insertCell(17);
...
function editarCliente(index) {
    ...
    document.getElementById("ramo").value = cliente.ramo;
    document.getElementById("nomeEmpresa").value = cliente.nomeEmpresa;
    document.getElementById("dataCriacao").value = cliente.dataCriacao;
    document.getElementById("cnpj").value = cliente.cnpj;
    document.getElementById("descricao").value = cliente.descricao;
    document.getElementById("redes").value = cliente.redes;
    ...
    window.location.href = "cadastroPage.html";
}
